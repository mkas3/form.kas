      ...
      <Section heading='API Reference'>
        <Subsection heading='Select'>
          <SubsectionDescription>
            A wrapper over the shadcn/ui Select.
          </SubsectionDescription>
          <ComponentProps
            componentProps={[
              {
        ...
        <Subsection heading='Select Trigger'>
          <SubsectionDescription>
            A wrapper over the shadcn/ui SelectTrigger.
          </SubsectionDescription>
        </Subsection>
        <Subsection heading='Select Value'>
          <SubsectionDescription>
            A wrapper over the shadcn/ui SelectValue.
          </SubsectionDescription>
        </Subsection>
        <Subsection heading='Select Content'>
          <SubsectionDescription>
            A wrapper over the shadcn/ui SelectContent.
          </SubsectionDescription>
        </Subsection>
        <Subsection heading='Select Item'>
          <SubsectionDescription>
            A wrapper over the shadcn/ui SelectItem.
          </SubsectionDescription>
        </Subsection>
        <Subsection heading='Select Group'>
          <SubsectionDescription>
            A wrapper over the shadcn/ui SelectGroup.
          </SubsectionDescription>
        </Subsection>
        <Subsection heading='Select Label'>
          <SubsectionDescription>
            A wrapper over the shadcn/ui SelectLabel.
          </SubsectionDescription>
        </Subsection>
